# Generated by Powerlevel10k configuration wizard on 2023-08-14 at 10:22 PDT.
...
# 12h time, vertical separators, round heads, slanted tails, 2 lines, solid, left frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    cpu_arch_joined         # CPU architecture
    shlvl
    # =========================[ Line #2 ]=========================
    newline                 # \n
    vcs                     # git status
  ...
  # Hrm...Sometimes the dir ends with '/' naturally, but sometimes not?
  #if [[  ?????? ]]; then
    typeset -g POWERLEVEL9K_DIR_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL="%F{$POWERLEVEL9K_DIR_ANCHOR_FOREGROUND}/"
  #fi
  ...
  typeset -g POWERLEVEL9K_DIR_MAX_LENGTH="95%"
  # When `dir` segment is on the last prompt line, try to shorten it enough to leave at least this
  # many columns for typing commands.
  typeset -g POWERLEVEL9K_DIR_MIN_COMMAND_COLUMNS=16
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND="${POWERLEVEL9K_DIR_FOREGROUND}" # close enough

  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=196
  # Default prompt symbol. (dir separator)
  ...
  ##############[ nvm: node.js version from nvm (https://github.com/nvm-sh/nvm) ]###############
  # Nvm color.
  typeset -g POWERLEVEL9K_NVM_FOREGROUND=03
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND=226
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%b %d %I:%M:%S %p}'
  ...
  typeset -g _prompt_shlvl=
  function prompt_shlvl() {
    # are we in a nested shell, have we already does thist test
    # is the parent process some zsh? yes? OK. Add the prompt
    if (( SHLVL != 1 )); then
      if [[ -z $_prompt_shlvl ]]; then
        _prompt_shlvl=nope
        [[ $(ps -o comm= -p $PPID) == *zsh ]] && _prompt_shlvl=nested
      fi
    fi
    [[ $_prompt_shlvl == "nested" ]] && p10k segment -f yellow -t "(🐚 $SHLVL)"
  }
...
function p10k-on-pre-prompt() {
  p10k display '1'=show '2/right_frame'=show #'ruler'=hide
}

function p10k-on-post-prompt() {
  p10k display '1'=hide '2/right_frame'=hide #'ruler'=show

  # this mess only works because we don't change the contents of the
  # last line.  The lprompt/rprompt are 'stale' relative to the
